...
public class TestClient {
	...
	public void initialiseData1() throws InvalidInputException {
		...
		customer1 = service.createAccount("Anubhav", "9876543210", new BigDecimal(9000));
		customer2 = service.createAccount("Akash","9513578426", new BigDecimal(5000));
		customer3 = service.createAccount("Nishant","9514786320",new BigDecimal(7500));
}
	...
	public void testIsValid2() throws InvalidInputException {
		Customer customer = new Customer("Nishant","9563214780",new Wallet(new BigDecimal(5000)));
		assertTrue(service.isValid(customer));
	}
